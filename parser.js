...
function handle_identifier(str) {
	...
	if (str[0] === "&") return ["js-global", ["wat-string", str.substring(1)]]; // sostituibile con &
	return str;
}
...
var cmt_stx = expect(sequence(";", repeat0(negate(line_terminator)), line_terminator))
